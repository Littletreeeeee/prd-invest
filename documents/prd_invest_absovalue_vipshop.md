...
|页面|指标|说明|
|:---:| :-----------: | :----------- |
|头条|文章PV、UV|可考虑设置url参数 ?utm_source=toutiaopush|
|资讯首页|页面PV、UV；页面平均停留时长|设置子目录 zixun-mainpage|
|资讯首页|焦点图点击量、点击UV|设置事件|
|资讯首页|四个专题点击量、点击UV|设置事件|
|专题页|页面PV、UV；页面平均停留时长|设置子目录 zixun-pd1-1;zixun-pd-2;zixun-pd-3;zixun-pd-4|
|文章详情页|页面PV、UV；页面平均停留时长|设置正则子目录 zixun-article|
