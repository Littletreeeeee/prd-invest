...
教育储蓄账户管理：领航的教育储蓄账户管理特点是费用低、管理专业、收益稳定、投资简单。
...
#### （2）运用的理论原理、算法
Fidelity Go 与其他在线理财建议提供服务类似，它在投资者对一系列问题回答情况的基础上提出推荐方案，这些问题旨在判断投资者的风险承受能力，财务状况和财务目标。

#### （3）底层资产及投资范围
Fidelity Go 组合中主要是 Fidelity 的产品。

#### （4）服务对象 / 目标市场定位
Fidelity Go 面向普通投资者，目标用户是了解数字化知识的年轻群体。Fidelity 也在针对投资顾问开发产品，其机构服务部门一直在为其他投资顾问提供服务。
#### （5）收费模式，投资门槛
所有费用在 0.35%~ 0.40% 之间，投资门槛为 5,000 美元。

#### （6）增值服务
自动资产再平衡：Fidelity Go 的服务包含对投资组合的重新权衡，并且将自动把新的贡献收益和分红所得投资出去，但不再收取佣金。

税收优化：它不会提供投资损失避税。但应税账户会通过投资贝莱德 iSharesETFs 及具有税收优惠的市政债券基金以最大限度降低税额。

#### （7）具体的应用场景、投资目标
1）投资计划；2）退休计划:包括准备退休和退休期间。

### 2.1.4 FutureAdvisor
#### （1）机构简介
FutureAdvisor 是一家数字化财富管理平台提供商，为用户提供智能投资建议。于2012年3月开始推出服务，由著名创业孵化平台 YCombinator 孵化，2013年2月正式上线业务。2015年8月26日，全球最大资 产管理公司之一贝莱德公司宣布100%收购FutureAdvisor。

FutureAdvisor被收购后，将经营名为 “贝莱德解决方案”的独立部门，同时也作为投资及风险管理平台。截至2016年3月，FutureAdvisor 资产管理规模有 7.89 亿美元。

#### （2）数字化资产配置运用的理论原理、算法
FutureAdvisor 是一种电子投资顾问，基于现代投资组合理论提供了自动化的财富管理。投资者可以保持他们在其他投资机构的个人投资账户，FutureAdvisor系统通过客户同步的其他机构理财账户数据及投资者的年龄和风险偏好进行定量分析，从投资组合的选择、费用成本和投资收益等角度给出优化建议。

#### （3）底层资产及投资范围
FutureAdvisor 投资于低费用的指数基金，主要是ETFs，其底层资产包括全球公司股票、债券、房地产投资信托。

此外，FutureAdvisor 投资全球范围资产以实现分散投资。

#### （4）服务对象 / 目标市场定位
FutureAdvisor 服务对象包括个人和机构。其中个人用户定位于10万美元左右的中产阶级。面向机构的B2B平台为金融机构的客户提供服务，以增加客户忠诚度，并增加咨询资产规模。

#### （5）收费模式，投资门槛
FutureAdvisor 提供的信息整合及优化建议都是免费的，当用户要求 FutureAdvisor 代理日常投资组合管理操作时，FutureAdvisor 才进行收费服务——费用约为用户要求管理的资产量的0.5%，相当于市面普遍价格的一半。

投资者可以免费试用3个月，门槛是10,000美元。

#### （6）增值服务
税收优化：为超过 20,000 美金资产规模的用户提供税收优化服务。

动态选择：基于已有的投资和税收情况对投资基金进行动态选择。

账户汇总并分析：FutureAdvisor提供自动和手动管理多个账户整体的投资管理服务，用户可以将自己各类投资账户导入FutureAdvisor，包括投资经纪账户、IRA账户和401K账户等。FutureAdvisor可以根据用户账户信息，对用户的账户进行分析。主要从投资回报、投资多样性、理财费用以及合理避税四个方面进行详细的分析、预测并给出系统评分。用户通过系统给出的这四方面评价，就可以全面了解自己的投资是否合理。

再平衡：系统可实现自动调整 , 以避免损失。

#### （7）具体的应用场景
老年人理财规划服务平台：主要是为老年人提供401K账户投资组合规划，用户将所需的信息输入电脑中，FutureAdvisor 链接各账户并分析投资者当前的投资组合，平台会根据投资组合的标准来分析各种费用和税收，让用户通过丰富的理财投资组合来减少费用或少交税，从而降低投资成本。

教育基金——完全免费的大学储蓄账户：账户设立时通过问卷估计投资者大学成本并设计一个计划来满足目标和预算，为投资者找到所在国家最节税和灵活的投资工具。之后会根据年龄和税收影响的变化自动投资，改变投资组合平衡，特别是接近目标日期时降低风险。
